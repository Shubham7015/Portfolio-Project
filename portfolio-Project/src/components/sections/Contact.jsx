  ...
  return (
    <section id="contact" className="relative py-20 bg-black overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary10 rounded-full blur-3xl opacity-30 " />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white  placeholder-white/40   focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/50 transition-all duration-300"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    placeholder="Message...."
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white  placeholder-white/40   focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/50 transition-all duration-300 resize-none"
                  />
                </div>
            ...
            <div className="">
              <div>
                ...
                <p className="text-white/60 leading-relaxed mb-6">
                  ...
                  project in mind or just want to say hi, feel free to reach
                  out.
                </p>
              </div>
              ...
              <div className="space-y-4">
               ...
               <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300  mb-6">
                  <div className="flex items-start gap-4 ">
                    <div className="p-3 bg-linear-to-br from-primary/20 to-primary/20 border border-primary/30 rounded-xl">
                    ...
                    .map(([platform, url]) => {
                      ...
                      return Icon ? (
                        <a
                          ...
                          className="p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-primary/50 
