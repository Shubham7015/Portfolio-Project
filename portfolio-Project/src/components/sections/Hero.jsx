...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black ">
      ...
      {/*Content Container */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pl-8 lg:pl-16 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/*Left Column - Content */}

          <div className="text-left">
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-[2.5px] px-[11px] mb-8 bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full">
            ...
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                Building modern, scalable web application with React,
            ...
            <FadeIn delay={300}>
              ...
              >
                <div className="relative z-10 bg-white text-[#212121] px-[26px] py-[13px] text-base font-medium border border-white rounded-xl">
                  Get in Touch
                </div>
              </button>
            </FadeIn>
            ...
            <div className="relative ">
              <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  <FadeIn delay={500}>
                    <div className="flex items-center gap-4 bg-black/40 backdrop-blur-sm border border-white/10 px-6 py-3">
