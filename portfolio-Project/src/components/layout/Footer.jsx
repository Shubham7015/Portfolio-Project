        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <FadeIn delay={0}>
            <div>
              ...
              <p className="text-white/60 text-sm mb-6 leading-relaxed">{PERSONAL_INFO.title}</p>
            ...
            <FadeIn delay={200}>
                <div>
                    ...
                    <p className="text-white/60 text-sm mb-6 leading-relaxed">Let's connect and build something amazing together</p>
                    <div className="flex flex-wrap gap-3">
                      {Object.entries(SOCIAL_LINKS).map(([platform,url])=>{
                        ...
                        return Icon ? (
                          ...
                          className="group relative p-4 bg-white/5 rounded-xl border border-white/10 
                          hover:bg-white/10 hover:border-primary/500 
